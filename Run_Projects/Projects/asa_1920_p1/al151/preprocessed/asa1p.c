...
int main()
{
  ...
  int n_alunos;
  int n_relacoes;
  n_alunos = new_sym_var(sizeof(int) * 8);
  n_relacoes = new_sym_var(sizeof(int) * 8);
  ...
  for (i = 0; i < n_alunos; i++)
  {
    in_nota = new_sym_var(sizeof(int) * 8);
  ...
  {
    in_aluno = new_sym_var(sizeof(int) * 8);
    in_relacao = new_sym_var(sizeof(int) * 8);
