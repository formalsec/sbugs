...
TopologicArray * topologic_sort_init(int V){
    TopologicArray * array = (TopologicArray*)malloc(sizeof(TopologicArray));
    setTAValues(array, (int*)malloc(sizeof(int) * V));
...
Grafo * new_grafo(int V, int E){
    ...
    setGrafoDomino(grafo, (Domino*)malloc(sizeof(Domino) * V));
...
long int longest_path(Grafo * DAG){
    ...
    int i = 0;
    long int res;
    long int * best_path = (long int*)malloc(sizeof(long int));
