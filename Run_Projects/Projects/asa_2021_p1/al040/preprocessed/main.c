...
Stack *stack_init()
{
  ...
  setStackHead(stack, 0);
  return stack;
}

int emptyStack(Stack *stack)
{
  return getStackHead(stack) == 0;
}
...
Grafo *new_grafo(int V, int E)
{
  ...
  for (; i < V; i++)
  {
    setDominoFather(get_domino(grafo, i), 0);
    setDominoLinks(get_domino(grafo, i), 0);
    setDominoNumLinks(get_domino(grafo, i), 0);
    setDominoSource(get_domino(grafo, i), 1);
    setDominoVisited(get_domino(grafo, i), !1);
    setDominoClosed(get_domino(grafo, i), !1);
...
void add_domino(Grafo *grafo, int V, int E)
{
  ...
  if (getDominoSource(get_domino(grafo, ind(E))))
  {
    ...
    setDominoSource(get_domino(grafo, ind(E)), !1);
  }
  else
  {
...
int main()
{
  ...
  for (; i < E; i++)
  {
    ...
    {
      dom = new_sym_var(sizeof(int) * 8);
      link = new_sym_var(sizeof(int) * 8);
