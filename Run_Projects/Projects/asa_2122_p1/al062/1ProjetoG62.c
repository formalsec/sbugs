...
int solveProblem2(){
  max=0;
  if((solutions2 = (int*)malloc((len2+1)*sizeof(int)))==NULL){
...
int solveProblem1(){
  if((solutions1len = (int*)malloc((len+1)*sizeof(int)))==NULL){
    printf("Memory not allocated\n");
    exit(0);
  }
  if((solutions1strs = (int*)malloc((len+1)*sizeof(int)))==NULL){
    printf("Memory not allocated\n");
    exit(0);
  }
  for (i=0; i<=len; i=i+1){
...
int getinput(char c){
  if((input1 = (int*)malloc(sizeof(int)))==NULL){
    printf("Memory not allocated\n");
    exit(0);
  }
  ...
  if(c-48==2){
    len2=0;
    if((input2 = (int*)malloc(sizeof(int)))==NULL){
      printf("Memory not allocated\n");
      exit(0);
    }
