...
int main()
{
  while (1)
  {
    ...
    {
      case 'a':
        argdescricao = new_sym_var(sizeof(char) * 8);
        argpreco = new_sym_var(sizeof(int) * 8);
        argpeso = new_sym_var(sizeof(int) * 8);
        argqtd = new_sym_var(sizeof(int) * 8);
        a(argdescricao, argpreco, argpeso, argqtd);
        break;

      case 'q':
        argidp = new_sym_var(sizeof(int) * 8);
        argqtd = new_sym_var(sizeof(int) * 8);
        q(argidp, argqtd);
        break;
      ...
      case 'A':
        argide = new_sym_var(sizeof(int) * 8);
        argidp = new_sym_var(sizeof(int) * 8);
        argqtd = new_sym_var(sizeof(int) * 8);
