...
int main()
{
  ...
  char comando;
  int nl_counter = 0;
  link *hashtable_games = 0;
  team_ptr list_teams = 0;
  link list_games = 0;
  ...
  while ((comando = getchar()) != 'x')
  {
    switch (comando)
    {
      case 'a':
        nl_counter++;
        list_games = a(hashtable_games, hashtable_size, list_teams, list_games, nl_counter);
        break;
      ...
      case 'r':
        nl_counter++;
        list_games = r(hashtable_games, hashtable_size, list_games, list_teams, nl_counter);
        break;
