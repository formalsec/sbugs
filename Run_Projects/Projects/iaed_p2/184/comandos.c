...
void A(linkE *headEptr,hptr *h1)
{
    char *nome_equipa;
    linkE aux;
    nome_equipa = (char*)malloc(sizeof(char)*MAX);
    scanf(" %[^:\n]", nome_equipa);
...
void a(linkJ *headJptr, linkE headE, hptr *h1)
{
    char *jogo, *e1, *e2;
    int p1, p2;
    jogo = (char*)malloc(sizeof(char)*MAX);
    e1 = (char*)malloc(sizeof(char)*MAX);
    e2 = (char*)malloc(sizeof(char)*MAX);
...
void P(linkE headE,hptr *h1)
{
    char *nome_e;
    linkE aux;
    nome_e = (char*)malloc(sizeof(char)*MAX);
    scanf(" %[^:\n]", nome_e);
