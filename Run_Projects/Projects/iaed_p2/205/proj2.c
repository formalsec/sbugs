...
void adiciona_novo_jogo(){
    ...
    char *buffer_nome=malloc(JOGO_MAX_SIZE_NAME);
    char *buffer_equipa1=malloc(EQUIPA_MAX_SIZE_NAME);
    char *buffer_equipa2=malloc(EQUIPA_MAX_SIZE_NAME);
...
void adiciona_nova_equipa(){
    ...
    char *buffer=malloc(EQUIPA_MAX_SIZE_NAME);
...
void procura_equipa(){
    Equipa *equipa=malloc(sizeof(Equipa));
    char *buffer_nome=malloc(EQUIPA_MAX_SIZE_NAME);
    link_equipa e;
