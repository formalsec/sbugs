...
jogo *cria_jogo(){
	jogo *novo_jogo = malloc(sizeof(jogo)+1);
	novo_jogo -> nome = NULL;
...
lista_jogos *cria_lista_jogos(){
	lista_jogos *nova_lista = malloc(sizeof(lista_jogos));
...
void preenche_jogo(jogo *jg, char* nome, char *equipa1, char *equipa2, char *score1, char *score2){
	jg -> nome = malloc(sizeof(char) * strlen(nome)+1);
	jg -> equipa1 = malloc(sizeof(char) * strlen(equipa1)+1);
	jg -> equipa2 = malloc(sizeof(char) * strlen(equipa2)+1);
	jg -> score1 = malloc(sizeof(char) * strlen(score1)+1);
	jg -> score2 = malloc(sizeof(char) * strlen(score2)+1);
	strcpy(jg -> nome, nome);
