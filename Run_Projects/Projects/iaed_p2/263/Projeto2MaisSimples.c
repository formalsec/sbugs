...
game* NEWGAME(char* name_game, char* team1, char* team2, int score1, int score2, int order){
  game *newgame = malloc(sizeof(game)); /* guardar memoria para o node do jogo */
  newgame->name_game = malloc(sizeof(char) * (strlen(name_game)+1)); /* guardar memoria para os caracteres das equipas e do nome do jogo */
