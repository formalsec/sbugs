...
{
    pEquipa x = malloc(sizeof(struct Equipa)); /* Aloca a memoria necessaria para equipas e coloca o nome e inicializa as vitorias a 0*/
...
{
    pEquipa *heads;
    heads = calloc(m, sizeof(pEquipa)); /*Aloca a memoria necessaria*/
    return heads;
}
