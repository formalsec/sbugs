...
TEAM newTeam(char *name) {
	TEAM g =malloc(sizeof(struct Team));                  /*aloca memoria para a estrutura da equipa*/
    g->Teamname=malloc(sizeof(char)*(strlen(name)+1));    /*aloca memoria para o nome da equipa*/
