...
struct AVL3 init3()
{
    ...
    p.a=INF; str.s=(char*) malloc(sizeof(char)); str.s[0]='a'; str.si=1; p.s=str;
...
{
    (*v).size++;
    (*v).a=(TYP7*) realloc((*v).a,((*v).size)*sizeof(TYP7));
    (*v).a[(*v).size-1]=val;
}
...
struct unordered_map6 init6(ll m) /*unordered_set with hashing*/
{
    ...
    unid.si=10L; unid.s=(char*) malloc(10*sizeof(char)); 
    unid.s = "impossible";
    H.a=init7(0);
    H.M=m; X = *((struct node6 *) malloc(sizeof(struct node6)));
...
{
    (*v).size++;
    (*v).a=(TYP9*) realloc((*v).a,((*v).size)*sizeof(TYP9));
    (*v).a[(*v).size-1]=val;
}
...
struct unordered_map8 init8(ll m) /*unordered_set with hashing*/
{
    ...
    unid.s = "impossible";
    H.a=init9(0);
    H.M=m; X = *((struct node8 *) malloc(sizeof(struct node8)));
