...
void A(bloco_hash_equipa *table_e,bloco_hash_equipa *lista_e, int NL){
    ...
    e = malloc(sizeof(equipa));                          /* guarda a equipa a adicionar */
    e->nome = malloc(sizeof(char)*(strlen(nome_e)+1));   /* garante que nao guarda espaco a mais na memoria para o nome da equipa a adicionar */
...
void g(bloco_hash_equipa *lista_e, int NL){                 /* recebe a lista de todas as equipas */
    ...
    lista_e_v = malloc(sizeof(bloco_hash_equipa));           /* inicializa a lista ordenada */
    lista_e_v[0] = NULL;                                     
