...
void edgeVectorInit(EdgeVector* v) {
    v->elems = 0;
    v->size = INITIAL_SIZE;
    v->minCut = (Edge*)malloc(sizeof(Edge)*INITIAL_SIZE);
}
...
void normalVectorInit(NormalVector* v) {
    v->elems = 0;
    v->size = INITIAL_SIZE;
    v->data = (int*)malloc(sizeof(int)*INITIAL_SIZE);
}
...
void vectorInit(Vector* v) {
    v->elems = 0;
    v->size = INITIAL_SIZE;
    v->capacity = (int*)malloc(sizeof(int)*INITIAL_SIZE);
    v->destination = (int*)malloc(sizeof(int)*INITIAL_SIZE);
}
