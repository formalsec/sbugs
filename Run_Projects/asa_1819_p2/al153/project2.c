...
int main(){/*Cada estação representa 2 vertices ligados por uma ligação com a capacidade da estação (o 2º vertice tem o numero da estação mais o numero de estações)*/
	...
	V=(vertice*)malloc(sizeof(vertice)*(f+(2*e)+2));/*Vetor com o registo dos vértices da rede (O elemento 0 corresponde a fonte)*/
	T=(liga*)malloc(sizeof(liga)*(t+f+e));/*Vetor com registo das ligações*//*Uma ligação extra por cada fornecedor e por cada extração*/
