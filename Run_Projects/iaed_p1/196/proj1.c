...
void ordena_precos(prd prds[], int n, int max)
{
    ...
    prd *ordenado = malloc(n * sizeof(prd)); /* Array que ira conter produtos ordenados */
    int *conta = calloc(max + 1, sizeof(int)); /*Tamanho maximo de chaves diferentes - inicializado a 0 */
