...
list_games** makeHashGames(){
    list_games **hash_table = (list_games**) malloc(sizeof(list_games*) * HASH_TABLE_SIZE);
    int i;
...
void addGame(list_games *lgptr, list_games **hashgames, team_node **hasteams, int line){
    char *match_name_buffer = (char*) malloc(sizeof(char) * MAX_NAME);
    char *team1_buffer = (char*) malloc(sizeof(char) * MAX_NAME);
    char *team2_buffer = (char*) malloc(sizeof(char) * MAX_NAME);
    int score1, score2;
    game *new_game;
