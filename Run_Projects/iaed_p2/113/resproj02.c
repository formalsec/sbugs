...
void ListaJogos(int NL, nodeJ **htJ) {
    ...
    nodeJ **n = calloc(HASHTABLE_TAM, sizeof(nodeJ *));
...
void EquipasGanhadoras(int NL, nodeE **htE) {
    ...
    n = calloc(HASHTABLE_TAM, sizeof(nodeJ *));
...
int main() {
    nodeJ **hashtableJ = calloc(HASHTABLE_TAM, sizeof(nodeJ *));
    nodeE **hashtableE = calloc(HASHTABLE_TAM, sizeof(nodeE *));
