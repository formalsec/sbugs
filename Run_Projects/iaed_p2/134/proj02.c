...
ht_j *ht_create_j(void) {
    ...
    hashtable->entries = malloc(sizeof(entry_j*) * TABLE_SIZE);
...
ht_e *ht_create_e(void) {
    ...
    /* allocate table entries*/
    hashtable->entries = malloc(sizeof(entry_e*) * TABLE_SIZE);
...
void ht_dump_j(ht_j *hashtable, int rnl) {
    ...
    for ( i = 0; i < TABLE_SIZE; ++i) {
        ...
        for(;;) {
            lista_jogos[index] = (entry_j*)malloc(sizeof(entry_j)); /*reallocating memory for the string (+1 is for '\0');*/
            lista_jogos[index]->equipa1 = (char*)malloc((strlen(entry->equipa1)+1) * sizeof(char)); /*reallocating memory for the string (+1 is for '\0');*/
            lista_jogos[index]->equipa2 = (char*)malloc((strlen(entry->equipa2)+1) * sizeof(char)); /*reallocating memory for the string (+1 is for '\0');*/
            lista_jogos[index]->nome = (char*)malloc((strlen(entry->nome)+1) * sizeof(char)); /*reallocating memory for the string (+1 is for '\0');*/
            ...
            case 'g':
                ...
                for ( i = 0; i < TABLE_SIZE; ++i) {
                    ...
                    for(;;) {
                        if (entry_equipa->vitorias == c)
                        {
                            strings[index] = (char*)malloc((strlen(entry_equipa->nome)+1) * sizeof(char)); /*reallocating memory for the string (+1 is for '\0');*/
