...
int main(){
    ...
    int *conta_linha=malloc(sizeof(int));            /*contador das linhas*/
    char *letra=malloc(sizeof(char));               /*variavel onde se guarda a primeira letra do input*/
    acede_jogo_normal *jogos_normais=malloc(sizeof(acede_jogo_normal));       /*Jogos_normais-->ponteiro para a lista ligada dos jogos*/
    acede_equipa_normal *equipas_normais=malloc(sizeof(acede_equipa_normal));  /*equipas_normais-->ponteiro para a lista ligada dos equipas*/
    acede_jogos *lista_ligada_jogos=malloc(sizeof(acede_jogos));              /*lista_ligada_jogos--> ponteiro para a hash table dos jogos*/
    lista_equipas *lista_ligada_equipas=malloc(sizeof(lista_equipas));        /*lista_ligada_equipas--> ponteiro para a hash table das equipas*/
