...
void A_NovaEquipa(int *NL, Hsh_Eq **tabela_eq, Lst_Eqs *lst_eqs) {
	char *nome_eq = malloc((MAX_CHAR+1) * sizeof(char));
...
void a_NovoJogo(int *NL, Hsh_Eq **tabela_e, Hsh_Jg **tabela_j, Lst_Jgs *lst_j){
	char *nome_j = malloc((MAX_CHAR+1) * sizeof(char));
	char *nome_e1 = malloc((MAX_CHAR+1) * sizeof(char));	
	char *nome_e2 = malloc((MAX_CHAR+1) * sizeof(char));
	int s1, s2;
...
void p_ProcuraJogo(int *NL, Hsh_Jg **tabela_j) {
	Jogo *j;
	char *nome = malloc((MAX_CHAR+1) *sizeof(char));
