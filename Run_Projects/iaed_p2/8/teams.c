...
TeamsDataItem * teams_create_item(Team *t) {
    ...
    EXIT_IF_ERROR("teams_create_item: malloc");
...
Teams * teams_new(){
    ...
    EXIT_IF_ERROR("teams_new: malloc 1");

    tt->count = 0;
    tt->items = (TeamsDataItem**) calloc(MAX_TEAMS, sizeof(TeamsDataItem*));
    EXIT_IF_ERROR("teams_new: malloc 2");
