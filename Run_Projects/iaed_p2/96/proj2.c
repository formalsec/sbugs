...
int main(){
    ...
    lista_j_ord_h = malloc(sizeof(bloco_hash_jogo));                     /* guarda memoria para a head da lista ligada */       
    lista_j_ord_t = malloc(sizeof(bloco_hash_jogo));                     /* guarda memoria para a tail da lista ligada */
    lista_e = malloc(sizeof(bloco_hash_equipa));                         /* guarda memoria para a lista das equipas */
