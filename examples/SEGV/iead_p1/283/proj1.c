...
int main(){
	...
	while (1) {
		...
		case 'a': 
			...
			adiciona_produto(descricao,preco,peso,qtd);           							/* Executa comando a */ 
			break;

		case 'q': 
			scanf("%d:%d", &ProductInd, &qtd_n);
			printf("%d %d", ProductInd, qtd_n);
			add_stock(ProductInd, qtd_n);                  							/* Executa comando q */ 
			break;
		case 'r': 
			scanf("%d:%d", &ProductInd, &qtd_n);
			remove_stock_produto(ProductInd, qtd_n);       							/* Executa comando r */ 
			break;
		case 'P':
			scanf("%d:%d",&ProductInd,&preco);
			altera_preco_prod(ProductInd, preco);		  							/* Executa comando P */ 
			break;
		/*case 'l':*/
