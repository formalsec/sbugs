...
int parseArgs(ElementLink* fListEl, ListLink** fListAdj) {
    ...
    scanf("%d", &size);
    ElementLink listEl = (ElementLink) can_fail_malloc(sizeof(struct element) * size);
    ListLink *listAdj = (ListLink*) can_fail_malloc(sizeof(ListLink) * size);
...
void getDivisions(ListLink* listAdj, ElementLink listEl, int size, int* countAP) {
	int i, subConj = 0;
    int *output = (int *) can_fail_malloc(sizeof(int)*size);
...
void getDivisionsAP(ListLink* listAdj, ElementLink listEl, int size, int* countAP) {
	int i, subConj = 0;
    int *count = (int *) can_fail_malloc(sizeof(int)*size);
