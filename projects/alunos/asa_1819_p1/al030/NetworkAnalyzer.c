...
void read_input(){
     ...
     */
    network = can_fail_malloc(sizeof(Node)*router_number);
...
void save_to_network(int node1, int node2){
     ...
     * beginning*/
    newnode2 = can_fail_malloc(sizeof(Node));
    newnode2->Id = node2;
    ...
    newnode1 = can_fail_malloc(sizeof(Node));
    newnode1->Id = node1;
...
void main_art(){
    ...
    node_depth = can_fail_malloc(sizeof(int)*router_number);
    node_low = can_fail_malloc(sizeof(int)*router_number);
    node_parent = can_fail_malloc(sizeof(int)*router_number);
    network_articulations = can_fail_malloc(sizeof(int)*router_number);
    subnetwork_identifiers = can_fail_malloc(sizeof(int)*router_number);
