...
{
    int i;
    int *child = (int *)can_fail_malloc(sizeof(int) * g->V);
    int *visited = (int *)can_fail_malloc(sizeof(int) * g->V);
    int *parent = (int *)can_fail_malloc(sizeof(int) * g->V);
...
int main(int argc, char *argv[])
{
    int subredes = 0;
    read_input();
    int *maxis = (int*) can_fail_malloc(sizeof(int)*g->V);
