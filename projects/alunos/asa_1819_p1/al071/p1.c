...
/*Funcao que cria no*/
No criaNo(int destino) {
    No novoNo = (No) can_fail_malloc(sizeof(struct node));
...
Graph criaGrafo(int vertices) {
    Graph novoGraph = (Graph) can_fail_malloc(sizeof(struct graph));
    novoGraph->vertices = vertices;

    /* Aloca memoria para as listas de adjacencia do grafo */
    novoGraph->listas = (List) can_fail_malloc(vertices * sizeof(struct list));
...
void DFS(Graph grafo) { 
    ...
    ListAPConca = (int*) can_fail_malloc(vertices * sizeof(int));
    visited = (int*) can_fail_malloc(vertices * sizeof(int));
    disc = (int*) can_fail_malloc(vertices * sizeof(int));
    low = (int*) can_fail_malloc(vertices * sizeof(int));
    parent = (int*) can_fail_malloc(vertices * sizeof(int));
    ap = (int*) can_fail_malloc(vertices * sizeof(int));
    listAux = (int*) can_fail_malloc(vertices * sizeof(int));
