...
void addNode(unsigned long router1, unsigned long router2, router *vertices){
	link *oneToTwo = (link *) can_fail_malloc(sizeof(link));
	link *twoToOne = (link *) can_fail_malloc(sizeof(link));
...
void dfs(router *vertices, unsigned long verticeNum) {
	...
	unsigned long *dfsDiscovery = (unsigned long*) can_fail_malloc(sizeof(unsigned long)*verticeNum);
	unsigned long *dfsPredecessor = (unsigned long*) can_fail_malloc(sizeof(unsigned long)*verticeNum);
	unsigned long *dfsLow = (unsigned long*) can_fail_malloc(sizeof(unsigned long)*verticeNum);
	bool *dfsSubtree = (bool*) can_fail_malloc(sizeof(bool)*verticeNum);
	bool *dfsSeen = (bool*) can_fail_malloc(sizeof(bool)*verticeNum);
...
int main() {
	...
	router *vertices = (router *) can_fail_malloc(sizeof(router)*verticeNum);
