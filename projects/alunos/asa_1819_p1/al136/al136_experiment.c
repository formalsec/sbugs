...
Graph createGraph(int num_vertices){
	Graph new_graph = (Graph)can_fail_malloc(sizeof(Graph*));
    new_graph->num_vertices = num_vertices;
    int i;
    for(i = 0; i<num_vertices; i++){
    	new_graph->List = (List) can_fail_malloc(num_vertices * sizeof(List*));
    }
...
void AP(Graph grafo){
    ...
    int* des = (int*)can_fail_malloc(sizeof(int)*grafo->num_vertices);
    int* isVisited = (int*)can_fail_malloc(sizeof(int)*grafo->num_vertices);
    int* parent = (int*)can_fail_malloc(sizeof(int)*grafo->num_vertices);
    int* low = (int*)can_fail_malloc(sizeof(int)*grafo->num_vertices);
    int* ap = (int*)can_fail_malloc(sizeof(int)*grafo->num_vertices);
    /*inicializada com o numero de todos os vertices pois todos podem ser um no isolado*/
    List_ID = (int*)can_fail_malloc(sizeof(int)*grafo->num_vertices);
...
int main(int argc, const char * argv[]) {
    ...
    ID_sub = 0;
    Lista_routers_vulneraveis = (int*)can_fail_malloc(sizeof(int)*vertices);
