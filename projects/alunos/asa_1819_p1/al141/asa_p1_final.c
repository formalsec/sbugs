...
data_t dfs(graph_t graph) {
	...
	int *discovery = (int*) can_fail_malloc(size * sizeof(int));
	int *low = (int*) can_fail_malloc(size * sizeof(int));
	int *parent = (int*) can_fail_malloc(size * sizeof(int));
	bool *artcVec = (bool*) can_fail_malloc(size * sizeof(bool));

	stack_t artcPoints = (stack_t) can_fail_malloc(sizeof(struct stack));
	stack_t subHeads = (stack_t) can_fail_malloc(sizeof(struct stack));
	initStack(subHeads);
	...
	data_t data = (data_t) can_fail_malloc (sizeof(struct data));
