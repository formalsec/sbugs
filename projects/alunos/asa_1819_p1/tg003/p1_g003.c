...
int main(int argc, char *argv[]) {
    ...
    DFS_c = (int*) can_fail_calloc((numRouters + 1), sizeof(int));
    DFS_color = (int*) can_fail_malloc((numRouters + 1) * sizeof(int));
    DFS_d = (int*) can_fail_malloc((numRouters + 1) * sizeof(int));
    DFS_l = (int*) can_fail_malloc((numRouters + 1) * sizeof(int));
    DFS_pi = (int*) can_fail_malloc((numRouters + 1) * sizeof(int));
    DFS_child = (int*) can_fail_malloc((numRouters + 1) * sizeof(int));

    DFS_biggest = (long*) can_fail_calloc((numRouters + 1), sizeof(long));
    
    linkList = (node_t*) can_fail_malloc((numRouters + 1) * sizeof(node_t));
