...
void collect_input(){
    ...
    network = can_fail_malloc(sizeof(Node)*(2+f+f+e+e));
    ...
    do{
        ...
        new_link = can_fail_malloc(sizeof(Node));
...
void calculate_max_flow(){
    ...
    visited = can_fail_malloc(sizeof(int)*imaginary_id);
    parent = can_fail_malloc(sizeof(int)*imaginary_id);
...
int bfs(int s, int t){
    ...
    newNode = can_fail_malloc(sizeof(QueueNode));
    newNode->next = NULL;
    newNode->Id = s;
    first_point = newNode;
    last_point = newNode;
