...
int relabelToFront(int **capacities, int ** flows, int source, int market) {
  ...
  excess = (int *) can_fail_calloc(numvertices, sizeof(int));
  height = (int *) can_fail_calloc(numvertices, sizeof(int));
  seen = (int *) can_fail_calloc(numvertices, sizeof(int));
  list = (int *) can_fail_calloc((numvertices-2), sizeof(int));
...
int main(void) {
  ...
  flows = (int **) can_fail_calloc(numvertices, sizeof(int*));
  capacities = (int **) can_fail_calloc(numvertices, sizeof(int*));
  transposed = (int **) can_fail_calloc(numvertices, sizeof(int*));
  for (i = 0; i < numvertices; i++) {
    flows[i] = (int *) can_fail_calloc(numvertices, sizeof(int));
    capacities[i] = (int *) can_fail_calloc(numvertices, sizeof(int));
    transposed[i] = (int *) can_fail_calloc(numvertices, sizeof(int));
  }
  ...
  visited = (int *) can_fail_calloc(numvertices, sizeof(int));
  DFS(transposed, visited,numvertices ,1);

  int *cutstations, *storedstations, st_c=0, lig_c=0;
  struct edge *cutedges;
  storedstations = (int *) can_fail_calloc(e, sizeof(int));
  cutstations = (int *) can_fail_calloc(e, sizeof(int));
  cutedges = (struct edge *) can_fail_malloc(connections* sizeof(struct edge));
