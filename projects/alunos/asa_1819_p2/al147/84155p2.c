...
int main()
{
    ...
    heights=(long*)can_fail_calloc(j+1, sizeof(long));

    vertices=(vertice*)can_fail_calloc(j, sizeof(vertice));
     ...
     * Criacao da matriz
     *****************************************************************************/
    listaLig = (no*)can_fail_calloc(j, sizeof(no));
    ...
    for(i=2;i<=(f+1);i++)
    {
        nova = (no*)can_fail_malloc(sizeof(no));
        if(nova==NULL) exit(0);
        ...
        nova2 = (no*)can_fail_malloc(sizeof(no));
    ...
    listaNos = (inteiro*)can_fail_malloc(sizeof(inteiro));
    if(listaNos==NULL) exit(0);
    listaNos->next = NULL;

    for(i=2;i<j;i++)
    {
        novo = (inteiro*)can_fail_malloc(sizeof(inteiro));
        if(novo==NULL) exit(0);
        novo->id = i;
    ...
    or_dest = (dubintlist*)can_fail_malloc(sizeof(dubintlist));
    if(or_dest==NULL) exit(0);
    or_dest->next = NULL;

    est = (inteiro*)can_fail_malloc(sizeof(inteiro));
    if(est==NULL) exit(0);
    est->next = NULL;
    ...
    while(auxNo->next != NULL)
    {
        ...
        while(auxLig != NULL)
        {
            if(vertices[auxLig->id].h<gap && auxLig->id !=0)
            {
                ...
                {
                    novo_e = (inteiro*)can_fail_malloc(sizeof(inteiro));
                ...
                {
                    novo_od = (dubintlist*)can_fail_malloc(sizeof(dubintlist));
    ...
    list_e = (long*)can_fail_calloc(p,sizeof(long));
    ...
    list = (dubint*)can_fail_calloc(k,sizeof(dubint));
    if(list==NULL) exit(0);
