...
int main(){
	...
	colorsBFS = (int*)can_fail_malloc(sizeof(int)*totalNodes+2);
	queueBFS = (int*)can_fail_malloc(sizeof(int)*totalNodes+2);
	predecessorBFS = (int*)can_fail_malloc(sizeof(int)*totalNodes);
	capacity = (struct matrix*)can_fail_malloc(sizeof(struct matrix));
	flux = (struct matrix*)can_fail_malloc(sizeof(struct matrix));
	transposed = (struct matrix*)can_fail_malloc(sizeof(struct matrix));
	queueDFS = (int*)can_fail_malloc(sizeof(int)*totalNodes);
	ligacoesAumentadas = (l*)can_fail_malloc(totalNodes * sizeof(struct ligacao));
	matrixesInit();
	...
	int *estacoesAumentadas = (int*)can_fail_malloc(sizeof(int)*totalNodes);
	int countE = 0;
	int countL = 0;
	for (i = 0; i <= totalNodes-1; ++i){
		if(queueDFS[i]==1){
 ...
 void matrixesInit(){
	...
	int i,z,j;
	capacity->mt = (int **)can_fail_malloc(sizeof(int *) * totalNodes);
	flux->mt = (int **)can_fail_malloc(sizeof(int *) * totalNodes);
	transposed->mt = (int **)can_fail_malloc(sizeof(int *) * totalNodes);
	
	for(i=0; i<totalNodes; i++){
		capacity->mt[i] = (int *)can_fail_malloc(totalNodes * sizeof(int));
		flux->mt[i] = (int *)can_fail_malloc(totalNodes * sizeof(int));
		transposed->mt[i] = (int *)can_fail_malloc(totalNodes * sizeof(int));
