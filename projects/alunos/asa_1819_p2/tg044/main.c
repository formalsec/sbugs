...
void addList(list_t *list, int data)
{
    node_t *newNode = (node_t *)can_fail_malloc(sizeof(node_t));
    newNode->data = data;
    newNode->next = NULL;
...
int *init_int_array()
{
    int *array = (int *)can_fail_malloc(number_vertices * sizeof(int));
    return array;
}
...
{
    int i;
    list_t **list = (list_t **)can_fail_malloc(number_vertices * sizeof(list_t*));
