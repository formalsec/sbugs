...
void merge(Student* arr[], int l, int m, int r) { 
    ...
    int szL = m - l + 1;
    int szR = r - m;
    Student** L = (Student **) can_fail_malloc(szL * sizeof(Student *));
    Student** R = (Student **) can_fail_malloc(szR * sizeof(Student *));
...
void addFriend(Student* u, Student* v) {
    ListNode newNode = (ListNode) can_fail_malloc(sizeof(struct listNode));
    newNode->student = u;
...
int main() {
    ...
    students = (Student *) can_fail_malloc(numStudents * sizeof(Student));
    studentsSorted = (Student **) can_fail_malloc(numStudents * sizeof(Student*));
