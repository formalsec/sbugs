...
no* criaNo(int valor) {
    no* novo_no = can_fail_malloc(sizeof(no));
    novo_no->valor = valor;
...
grafo* criaGrafo(int num_vertices) {
    grafo* g = (grafo*) can_fail_malloc(sizeof(grafo));
    g->num_vertices = num_vertices;
    g->visitado = (int*) can_fail_malloc((num_vertices+1) * sizeof(int));
    g->valores = (int*) can_fail_malloc((num_vertices+1) * sizeof(int));
    g->listas_adjacencia = (no**) can_fail_malloc((num_vertices+1) * sizeof(no*));
