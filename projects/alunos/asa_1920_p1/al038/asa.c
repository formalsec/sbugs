...
Graph* createGraph(int numVertices) {
    ...
    graph->adjLists = (Vertex**)can_fail_malloc((numVertices+1)*sizeof(Vertex*));
    graph->grades = (int*)can_fail_malloc((numVertices + 1) *sizeof(int));
...
Vertex* createVertex(int student) {
    Vertex* newVertex = (Vertex*)can_fail_malloc(sizeof(Vertex));
...
void search(Graph* graph) {
    int* disc = (int*)can_fail_malloc(sizeof(int)*(graph->numVertices+1));
    int* low = (int*)can_fail_malloc(sizeof(int)*(graph->numVertices + 1));
    bool* stackMember = (bool*)can_fail_malloc(sizeof(int)*(graph->numVertices + 1));
