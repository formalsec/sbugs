...
int main(int argc, char* argv[]) {
	...
	for (i = 0; i < numRelationships; i++) {
		...
		if (student[giver - 1].relationshipsCurrent->value == -1) {
			...
			student[giver - 1].relationshipsCurrent->next = can_fail_malloc(sizeof(node));
