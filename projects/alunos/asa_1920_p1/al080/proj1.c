...
Stack* createStack(int size) {
    int i;
    Stack* s = can_fail_malloc(sizeof(Stack));
    s->size = size;
    s->top = NIL;
    s->values = can_fail_malloc(sizeof(int)*size);
    s->onStack = can_fail_malloc(sizeof(int)*(size+1));
...
Graph* createGraph(int V) {
    ...
    g->V = V;
    g->adjList = can_fail_malloc(sizeof(Node)*(V+1));
    g->grade = can_fail_malloc(sizeof(int)*(V+1));
    g->low = can_fail_malloc(sizeof(int)*(V+1));
    g->d = can_fail_malloc(sizeof(int)*(V+1));
    g->color = can_fail_malloc(sizeof(int)*(V+1));
    g->SCCId = can_fail_malloc(sizeof(int)*(V+1));
    g->SCCGrades = can_fail_malloc(sizeof(int)*(V+1));
