...
void processInput() {
    ...
    friendsByID = (Friend**) can_fail_calloc(nFriends, sizeof(Friend*));

    for (i = 0; i < nFriends; ++i) {
        scanf("%d",&grade);

        friend = (Friend*) can_fail_calloc(1, sizeof(struct friend));
...
void addHelped(Friend* friend, Friend* helped) {
    ...
    Helped* helpedFriend = (Helped*) can_fail_calloc(1, sizeof(struct helped));
