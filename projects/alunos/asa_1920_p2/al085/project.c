...
void processInput() {
    ...
    char *indexKeeper = can_fail_malloc((nBoulevards * nStreets * 2) * sizeof(char));
...
void initGraph() {
    ...
    adjList = can_fail_malloc(((nBoulevards * nStreets * 2) + 2) * sizeof(node*));
    ...
    colors = can_fail_malloc(((nBoulevards * nStreets * 2) + 2) * sizeof(int));
    parents = can_fail_malloc(((nBoulevards * nStreets * 2) + 2) * sizeof(int));
    clearDFS();
}
