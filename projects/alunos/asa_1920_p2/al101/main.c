...
list* newList() {
    list* new = (list*) can_fail_malloc(sizeof(list));
...
void addEdge(int from, int to, int cap) {
    ...
    edge new = (edge) can_fail_malloc(sizeof(vertice));
    new->next = NULL;
    new->id = to;
    new->cap = cap;
...
void processInput() {
    ...
    adj = (list**) can_fail_malloc(sizeof(list*) * g);
...
int edmondsKarp(int startNode, int endNode) {
    ...
    parentsList = (int*) can_fail_malloc(sizeof(int) * g);
    currentPathCapacity = (int*) can_fail_malloc(sizeof(int) * g);
