...
int *cut(char buffaux[]) {
  int *mn=(int*)can_fail_malloc(sizeof(int)*2);
  char delim[]=" ";
...
void initmatrixmn(arrc *ac, int m, int n) {
  ...
  int j;
  for (i=0; i<m; i++) {
    ac[i].tc=(tc*)can_fail_malloc(sizeof(struct tc)*n);
    for (j=0; j<n; j++) {
      ac[i].tc[j].s=0;
      ac[i].tc[j].c=0;
      ac[i].tc[j].cruz.a=i;
      ...
      ac[i].tc[j].numc=0;
      if (i==0 && j==0) {
        ac[0].tc[0].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*2);
        ac[0].tc[0].adj[0].a=0;
        ac[0].tc[0].adj[0].r=1;
        ac[0].tc[0].adj[1].a=1;
        ac[0].tc[0].adj[1].r=0;
      ...
      if (i==0 && j==n-1) {
        ac[i].tc[j].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*2);
        ac[i].tc[j].adj[0].a=0;
      ...
      if (i==0 && j>0 && j<n-1) {
        ac[i].tc[j].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*3);
        ac[i].tc[j].adj[0].a=i;
        ac[i].tc[j].adj[0].r=j+1;
        ac[i].tc[j].adj[1].a=i;
      ...
      if (i>0 && i<m-1 && j>0 && j<n-1) {
        ac[i].tc[j].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*4);
        ac[i].tc[j].adj[0].a=i;
        ac[i].tc[j].adj[0].r=j+1;
        ac[i].tc[j].adj[1].a=i;
        ac[i].tc[j].adj[1].r=j-1;
...
void initmatrix11(arrc *ac, int m, int n) {
  int i;
  if (m==1 && n==1) {
    ac[0].tc=(tc*)can_fail_malloc(sizeof(struct tc)*1);
    ac[0].tc[0].s=0;
    ac[0].tc[0].c=0;
    ac[0].tc[0].cruz.a=0;
    ac[0].tc[0].cruz.r=0;
  ...
  if (m==1 && n>1) {
    ac[0].tc=(tc*)can_fail_malloc(sizeof(struct tc)*n);
    for (i=0; i<n; i++) {
      ac[0].tc[i].s=0;
      ac[0].tc[i].c=0;
      ac[0].tc[i].cruz.a=0;
      ...
      ac[0].tc[i].numc=0;
      if (i==0) {
        ac[0].tc[i].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*1);
        ac[0].tc[i].adj[0].a=0;
        ac[0].tc[i].adj[0].r=i+1;
        ac[0].tc[i].numadj=1;
      }
      if (i>0 && i<n-1) {
        ac[0].tc[i].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*2);
        ac[0].tc[i].adj[0].a=0;
        ac[0].tc[i].adj[0].r=i+1;
        ac[0].tc[i].adj[1].a=0;
  ...
  if (m>1 && n==1) {
    for (i=0; i<m; i++) {
      ac[i].tc=(tc*)can_fail_malloc(sizeof(struct tc)*1);
      ac[i].tc[0].s=0;
      ac[i].tc[0].c=0;
      ac[i].tc[0].cruz.a=i;
      ac[i].tc[0].cruz.r=0;
      ...
      ac[i].tc[0].numc=0;
      if (i==0) {
        ac[0].tc[0].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*1);
        ac[0].tc[0].adj[0].a=i+1;
        ac[0].tc[0].adj[0].r=0;
        ac[0].tc[0].numadj=1;
      }
      if (i>0 && i<m-1) {
        ac[i].tc[0].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*2);
      ...
      if (i==m-1) {
        ac[i].tc[0].adj=(cruz*)can_fail_malloc(sizeof(struct cruz)*1);
        ac[i].tc[0].adj[0].a=i-1;
        ac[i].tc[0].adj[0].r=0;
        ac[i].tc[0].numadj=1;
      }
  ...
  for (i=0; i<s.numadj;i++) {
    if (ac[s.adj[i].a].tc[s.adj[i].r].c==1  && ac[s.adj[i].a].tc[s.adj[i].r].s==0 && ac[s.adj[i].a].tc[s.adj[i].r].v==0) {
      if (ac[s.adj[i].a].tc[s.adj[i].r].numc==0) {
        ac[s.adj[i].a].tc[s.adj[i].r].cams=(caminho*)can_fail_malloc(sizeof(struct caminho)*1);
        ac[s.adj[i].a].tc[s.adj[i].r].cams[0].cruz=(cruz*)can_fail_malloc(sizeof(struct cruz)*1);
        numv=1;
        ac[s.adj[i].a].tc[s.adj[i].r].cams[0].cruz[0]=ac[s.adj[i].a].tc[s.adj[i].r].cruz;
        for (p=currentnode; p!=NULL; p=p->prev) {
          ac[s.adj[i].a].tc[s.adj[i].r].cams[0].cruz=can_fail_realloc(ac[s.adj[i].a].tc[s.adj[i].r].cams[0].cruz, sizeof(struct cruz)*(numv+1));
        ...
        numv=1;
        ac[s.adj[i].a].tc[s.adj[i].r].cams=can_fail_realloc(ac[s.adj[i].a].tc[s.adj[i].r].cams, sizeof(struct caminho)*(numc+1));
        ac[s.adj[i].a].tc[s.adj[i].r].cams[numc].cruz=(cruz*)can_fail_malloc(sizeof(struct cruz)*1);
        ac[s.adj[i].a].tc[s.adj[i].r].cams[numc].cruz[0]=ac[s.adj[i].a].tc[s.adj[i].r].cruz;
        for (p=currentnode; p!=NULL; p=p->prev) {
          ac[s.adj[i].a].tc[s.adj[i].r].cams[numc].cruz=can_fail_realloc(ac[s.adj[i].a].tc[s.adj[i].r].cams[numc].cruz, sizeof(struct cruz)*(numv+1));
    ...
    if (ac[s.adj[i].a].tc[s.adj[i].r].c==0 && ac[s.adj[i].a].tc[s.adj[i].r].s==0 && ac[s.adj[i].a].tc[s.adj[i].r].v==0) {
      ...
      nextnode=can_fail_malloc(sizeof(struct node));
...
void verify(tc s, arrc *ac, int m, int n) {
  int v=0;
  struct node *head=can_fail_malloc(sizeof(struct node));
...
void max(arrc *ac, cruz *cc, cruz *ss, int m, int n, int c, int s) {
  ...
  int cont=0;
  int ret=0;
  caminho *cmsesc=(caminho*)can_fail_malloc(sizeof(struct caminho)*c);
  for (j=0; j<s; j++) {
...
int main() {
  ...
  sreal=s;
  ccreal=c;
  ss=(cruz*)can_fail_malloc(sizeof(struct cruz)*s);
  cc=(cruz*)can_fail_malloc(sizeof(struct cruz)*c);
  ac=(arrc*)can_fail_malloc(sizeof(struct arrc)*(m));
  contfinal=0;
  contint=0;
