...
void readInput(){
    ...
    G.V = nProcesses + 2; 
    G.adj =  (link**) can_fail_malloc(sizeof(link) * G.V);

    for(i = 0; i < nProcesses; i++){
        link *edgeXP = can_fail_malloc(sizeof(link)),*edgeYP = can_fail_malloc(sizeof(link)),*edgePX = can_fail_malloc(sizeof(link)),*edgePY = can_fail_malloc(sizeof(link));
    ...
    for(i = 0; i < nCosts; i++){
        link *edge1_2 = can_fail_malloc(sizeof(link)), *edge2_1 = can_fail_malloc(sizeof(link));
