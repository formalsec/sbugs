 ...
 ************************************************************/
 ...
 int main()
 {
 	...
 	if(scanf("%d %d", &processos, &comunicacoes) == 2)
	{
    	...
    	Fila = can_fail_malloc(sizeof(int)*raiz_matriz);
		matriz.Com = can_fail_malloc(sizeof(int*)*raiz_matriz);          
   		matriz.Fluxo = can_fail_malloc(sizeof(int*)*raiz_matriz);

   		for(i = 0; i < (raiz_matriz); i++)
   		{   			 
      		matriz.Fluxo[i] = can_fail_malloc(sizeof(int)*raiz_matriz);   
     		matriz.Com[i] = can_fail_malloc(sizeof(int)*raiz_matriz);        
    	}
    	...
    	matriz.visitado = can_fail_malloc(sizeof(int)*raiz_matriz);                    
    	matriz.path = can_fail_malloc(sizeof(int)*raiz_matriz);
