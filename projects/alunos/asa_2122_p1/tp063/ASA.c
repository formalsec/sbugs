...
int main() {
    ...
    int key;
    x = can_fail_malloc(sizeof(int) * r);
    y = can_fail_malloc(sizeof(int) * r);
    ...
    if (n == 1) {
        while (temp != '\n') {
            ...
            if (i + 1 > r) {
                r *= 2;
                x = can_fail_realloc(x, sizeof(int) * r);
    ...
    if (n == 2) {
        while (temp1 != '\n') {
            ...
            if (l1 + 1 > r) {
                r *= 2;
                x = (int *) can_fail_realloc(x, sizeof(int) * r);
            }
        }
        r = MAX_ARRAY_SIZE;
        while (temp2 != '\n') {
            ...
            if (l2 + 1 > r) {
                r *= 2;
                y = (int *) can_fail_realloc(y, sizeof(int) * r);

            }
        }
        int *arr1;
        arr1 = can_fail_malloc(sizeof(int) * l1);
        for (i = 0; i < l1; i++) {
            arr1[i] = x[i];
        }

        int *arr2;
        arr2 = can_fail_malloc(sizeof(int) * l2);
        for (i = 0; i < l2; i++) {
            arr2[i] = y[i];
        }
