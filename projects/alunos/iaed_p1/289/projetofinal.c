...
/* funcao que vai realizar o comando 'l', lista todos os produtos existentes no sistema por ordem crescente de pre?o */
...
void removeStock(Product products[MAX_PRODUCTS], int numProducts){ 
    ...
    scanf("%d:%d", &id, &qtd);
    /* o id nunca pode ser maior que o numero de produtos, isso h impossivel, da? a logica usada
...
/* funcao que vai realizar o comando 'p', altera o pre?o de um produto existente no sistema */
...
/* funcao que vai realizar o comando 'L', lista todos os produtos de uma encomenda por ordem alfab?tica da descri??o */
...
/* funcao que vai realizar o comando 'E', lista a descri??o e a quantidade de um produto numa encomenda */
