...
char *realoca_memoria_da_string(char *string_a_ser_realocada)
{
	...
	char *string_a_devolver = can_fail_malloc(bytes_a_alocar);
...
{	
	...
	/* Alocar memoria */
	equipa_a_adicionar = (Lista_de_equipas *)can_fail_malloc(sizeof(Lista_de_equipas)); 
...
{	
	...
	/* Alocar memoria */
	jogo_a_adicionar = (Lista_de_jogos *)can_fail_malloc(sizeof(Lista_de_jogos)); 
	/* inicializar os ponteiros para nao dar erros no valgrind */
