...
lstEquipas criar_lst_equipas() {
    ...
    lstEquipas lista = (lstEquipas) can_fail_malloc(sizeof(struct lst_equipas));
...
void adicionar_equipa_lst(lstEquipas lista, ptrEquipa equipa) {
    ...
    nova_equipa = (linkEquipa) can_fail_malloc(sizeof(struct no_equipa));
...
lstJogos criar_lst_jogos() {
    /* Reserva memoria para a lista */
    lstJogos lista = (lstJogos) can_fail_malloc(sizeof(struct lst_jogos));
...
void adicionar_jogo_lst(lstJogos lista, ptrJogo jogo) {
    ...
    novo_jogo = (linkJogo) can_fail_malloc(sizeof(struct no_jogo));
