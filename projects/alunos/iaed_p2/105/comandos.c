...
equipa *tabela_hash_equipa[MAX_TABELA],node_lista **inicio,node_lista **fim) {
    jogo *novo_jogo =  (jogo *) can_fail_malloc(sizeof(jogo)); /* criar novo jogo */
    ...
    novo_jogo->nome = (char*) can_fail_malloc((strlen(str1)+1)*sizeof(char));
    novo_jogo->equipa1 = (char*) can_fail_malloc((strlen(str2)+1)*sizeof(char));
    novo_jogo->equipa2 = (char*) can_fail_malloc((strlen(str3)+1)*sizeof(char));
...
void adiciona_equipa(int NL,equipa *tabela_hash_equipa[MAX_TABELA]) {
    equipa *nova_equipa = can_fail_malloc(sizeof(*nova_equipa)); /*criar nova equipa*/
    char str1[MAX_STR]; /*nome da equipa*/
    scanf(" %[^\n]",str1);
    /*alocar memoria necessaria para inserir a equipa na tabela*/
    nova_equipa->nome = (char*) can_fail_malloc((strlen(str1)+1)*sizeof(char));
