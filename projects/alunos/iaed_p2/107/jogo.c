...
no_jogo_tabela *cria_jogo(char nome[],char equipa1[],char equipa2[],int score1,int score2){
    no_jogo_tabela *novo = (no_jogo_tabela*) can_fail_malloc(sizeof(no_jogo_tabela));
    novo->proximo = NULL;
    novo->pos_fila = NULL;
    novo->anterior = NULL;
    novo->jogo1.nome = can_fail_malloc((strlen(nome)+1)*sizeof(char));
    strcpy(novo->jogo1.nome,nome);
    novo->jogo1.equipa1 = can_fail_malloc((strlen(equipa1)+1)*sizeof(char));
    strcpy(novo->jogo1.equipa1,equipa1);
    novo->jogo1.equipa2 = can_fail_malloc((strlen(equipa2)+1)*sizeof(char));
...
char nome[],char equipa1[],char equipa2[],int score1,int score2){
    ...
    no_jogos *novo_no = can_fail_malloc(sizeof(no_jogos));
    int pos = hash(nome);
    equipa *alvo;
