...
void add_team(teams **lst_teams, int nl)
{
    ...
    {
        /*variables*/
        teams *team = (teams*)can_fail_malloc(sizeof(teams));
...
void add_game(games **lst_games, teams **lst_teams, int nl, stacks **stack, stacks **head_stack)
{
    ...
    {
        /*variables*/
        games * game = (games*)can_fail_malloc(sizeof(games));
...
int main()
{
    ...
    lst_teams = (teams **)can_fail_malloc(sizeof(teams)*517);/*initializing main list of teams*/
    lst_games = (games **)can_fail_malloc(sizeof(games)*517);/*initializing main list of games*/
    stack = (stacks **)can_fail_malloc(sizeof(stacks));/*initializing the stack*/
    head_stack = (stacks **)can_fail_malloc(sizeof(stacks));/*initializing the head of the stack*/
    best_teams = (char **)can_fail_malloc(sizeof(char *)*100);/*initializing the list of strings*/
