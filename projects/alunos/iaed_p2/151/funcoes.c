...
void adiciona_equipa(linkeq* hash_equipas, int linha){
    ...
    pequipa = can_fail_malloc(sizeof(equipa));
    pequipa->nome = (char*) can_fail_malloc(sizeof(char)*(strlen(nome)+1));
...
void lista_melhores_equipas(linkeq* hash_equipas, int linha){
    ...
    linkeq aux;
    equipa **l = can_fail_malloc(sizeof(equipa*));
    l[0] = NULL;
    ...
    for (i = 0; i < TAM_HASH; i++){
        ...
        while (aux != NULL){
            ...
            if (aux->pequipa->vitorias > max_vitorias){
                ...
                tamanho_lista = 1;
                l = can_fail_realloc(l, sizeof(equipa*));
                l[0] = aux->pequipa;
            }
            ...
            ultima posicao da lista */
                ...
                tamanho_lista++;
                l = can_fail_realloc(l, (tamanho_lista)*sizeof(equipa*));
