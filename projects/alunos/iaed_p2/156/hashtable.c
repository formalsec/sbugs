...
equipa_pont* inic_hash_equipa() {
    ...
    tabela_hash = (equipa_pont*)can_fail_malloc(Hash_equipas*sizeof(equipa_pont));
    /*Guarda o tabela hash com o can_fail_malloc.*/
...
jogo_pont* inic_hash_jogo() {
    ...
    tabela_hash = (jogo_pont*)can_fail_malloc(Hash_jogos*sizeof(jogo_pont));
    /*Guarda o tabela hash com o can_fail_malloc.*/
...
/*Esta funcao limpa todos os can_fail_mallocs que tinham sido feitos para ambas as tabelas hash.*/
