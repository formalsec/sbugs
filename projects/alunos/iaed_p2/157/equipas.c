...
pt_equipa nova_equipa (char * nome)
{
    ...
    equipa_nova = (pt_equipa) can_fail_malloc(sizeof(struct equipa));

    /* Aloca espaco para o nome da equipa e atribui-lo */
    equipa_nova->nome = (char*) can_fail_malloc(comp * sizeof(char));
...
void insere_equipa_tabela (pt_equipa equipa, link_equipa * equipas)
{
    ...
    link_equipa new = (link_equipa) can_fail_malloc(sizeof(struct node_equipa));
