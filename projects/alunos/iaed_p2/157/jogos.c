...
pt_jogo novo_jogo (char * nome, char * equipa1, char * equipa2, int score1, int score2, link_equipa * equipas)
{
    ...
    jogo_novo = (pt_jogo) can_fail_malloc(sizeof(struct jogo));

    /* Aloca espaco para o nome do jogo e atribui-lo */
    jogo_novo->nome = (char*) can_fail_malloc(comp * sizeof(char));
...
void insere_jogo_tabela (pt_jogo jogo, link_jogo * jogos)
{
    ...
    link_jogo new = (link_jogo) can_fail_malloc(sizeof(struct node_jogo));
...
pt_nome novo_nome (char * nome, pt_nome nomes_jogos)
{
    ...
    novo_nome = (pt_nome) can_fail_malloc(sizeof(struct nome));
    novo_nome->next = NULL;
    ...
    comp = strlen(nome) + 1;    
    nomes_jogos->nome = (char*) can_fail_malloc(comp * sizeof(char));
