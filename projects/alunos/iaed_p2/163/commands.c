...
link a(link* hashtable, int size_table, team_ptr team_list
    ...
    aux_name = (char*) can_fail_malloc(sizeof(char) * MAXSTRING);
    aux_team1_name = (char*) can_fail_malloc(sizeof(char) * MAXSTRING);
    aux_team2_name = (char*) can_fail_malloc(sizeof(char) * MAXSTRING);
...
team_ptr A(team_ptr team_list, int nl){
    ...
    aux_team_name = (char*) can_fail_malloc(sizeof(char) * MAXSTRING);
...
void p(link* hashtable, int size_table, int nl){
    ...
    aux_game_name = (char*) can_fail_malloc(sizeof(char) * MAXSTRING);
...
void g(team_ptr team_list, int nl){
    ...
    if(team_list != NULL){
        ...
        for(i = 0, x= team_list; x!= NULL; i++, x = x->next){
            if(x->games_won == biggest_n_games_won){
                team_names[i] = (char*) can_fail_malloc(sizeof(char) * (strlen(x->team_name)+1));
