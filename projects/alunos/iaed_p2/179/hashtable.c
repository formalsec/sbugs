...
Ht_games HTGinit(int max){
    Ht_games ht = can_fail_malloc(sizeof(struct ht_games));
    int i;
    ht->num = 0;
    ht->size = 2*max;
    ht->games = can_fail_malloc(ht->size*sizeof(Game));
...
Ht_teams HTTinit(int max){
    Ht_teams ht = can_fail_malloc(sizeof(struct ht_teams));
    int i;
    ht->num = 0;
    ht->size = 2*max;
    ht->teams = can_fail_malloc(ht->size*sizeof(Team));
