...
char* duplica_string(char *string)
{
    ...
    string_duplicada = (char*) can_fail_malloc((strlen(string) + 1));
...
{   
    ...
    /* Alocar memoria */
    nova_equipa = (Equipa*) can_fail_malloc(sizeof(struct equipa));
...
NodeEquipa* cria_NodeEquipa (Equipa *equipa)
{
    ...
    /* Alocar memoria */
    node_equipa = (NodeEquipa*) can_fail_malloc(sizeof(struct node_equipa));
