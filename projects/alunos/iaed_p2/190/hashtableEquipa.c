...
void initEquipa(int m) {
    int i;
    headsEquipa = (NodeEquipa **)can_fail_malloc(m*sizeof(NodeEquipa *));
...
void insertEquipa(int tamHashEquipa,ItemEquipa item) {
    ...
    NodeEquipa * newNodeE = (NodeEquipa *) can_fail_malloc(sizeof(NodeEquipa));
    newNodeE->item = item;
...
ItemEquipa * HashToArrayEquipa(int tamHashEquipa, int contadorEquipas){
    ...
    int i,j=0;
    NodeEquipa * head;
    array = (ItemEquipa *) can_fail_malloc(sizeof(ItemEquipa)*contadorEquipas);
