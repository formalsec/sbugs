...
Game_List *init_game_list() {
	...
	Game_List *GL = can_fail_malloc(sizeof(Game_List));
...
void add_last_game_list(Game_List *GL, Game game) {
	...
	Game_Node *new_game_node = can_fail_malloc(sizeof(Game_Node));
	...
	new_game_node->game = can_fail_malloc(sizeof(struct game_node));
	new_game_node->game->name = can_fail_malloc(sizeof(char) * (strlen(game->name) + 1));
	new_game_node->game->team1 = can_fail_malloc(sizeof(char) * (strlen(game->team1) + 1));
	new_game_node->game->team2 = can_fail_malloc(sizeof(char) * (strlen(game->team2) + 1));
