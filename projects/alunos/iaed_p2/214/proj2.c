...
int main() {
    ...
    table = (link *) can_fail_malloc(sizeof(link) * TABLE_SIZE);
    for (i = 0; i < TABLE_SIZE; i++)
        table[i] = NULL;

    tablet = (link1 *) can_fail_malloc(sizeof(link1) * TABLE_SIZE);
    for (i = 0; i < TABLE_SIZE; i++)
        tablet[i] = NULL;
...
link addGame(link linkedList, link* table, link1* tablet){
    ...
    nameg =(char *) can_fail_malloc(sizeof(char) * strlen(name) + 1);
    strcpy(nameg, name);

    team1 = (char *) can_fail_malloc(sizeof(char) * strlen(name1) + 1);
    strcpy(team1, name1);
            
    team2 = (char *) can_fail_malloc(sizeof(char) * strlen(name2) + 1);
    strcpy(team2, name2);
  
    scoret1 = (char *) can_fail_malloc(sizeof(char) * strlen(score1) + 1);
    strcpy(scoret1, score1);

    scoret2 = (char *) can_fail_malloc(sizeof(char) * strlen(score2) + 1);
...
Game createGame(char *name, char *name1, char *name2, char *scoret1, char *scoret2, link1* tablet) {
    ...
    game = (Game) can_fail_malloc(sizeof(struct Games));
...
link1 addTeam(link1 teamsList, link1* tablet){
    ...
    team1 =(char *) can_fail_malloc(sizeof(char) * strlen(name) + 1);
    strcpy(team1, name);
...
Team createTeam(char *name) {
    ...
    team = (Team) can_fail_malloc(sizeof(struct Teams));
...
void editGameScore(link *table) {
    ...
    n->g->score1 = can_fail_realloc(n->g->score1, sizeof(char) * strlen(scoret1) + 1);
    strcpy(n->g->score1, scoret1);

    n->g->score2 = can_fail_realloc(n->g->score2, sizeof(char) * strlen(scoret2) + 1);
...
link insert(link head, Game g) { /*jogo*/
    ...
    link newNode = (link) can_fail_malloc(sizeof(struct node));
    newNode->g = g;
    newNode->next = head;
...
link1 insertTeam(link1 head, Team t) { /*equipa*/
    ...
    link1 n;
    link1 temp;
    link1 newNode1 = (link1) can_fail_malloc(sizeof(struct node1));
