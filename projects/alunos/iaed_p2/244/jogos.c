...
jogo_t *criar_jogo(char *nome, char *eq1, char *eq2, int pt1, int pt2){
	...
	jogo_t *t = can_fail_malloc(sizeof(jogo_t));

	t->nome = can_fail_malloc(sizeof(char) * (strlen(nome) + 1 ));

	t->eq1 = can_fail_malloc(sizeof(char) * (strlen(eq1) + 1 ));

	t->eq2 = can_fail_malloc(sizeof(char) * (strlen(eq2) + 1 ));
...
htable_entrada_jogo_t* adicionar_a_lista_de_jogo(htable_entrada_jogo_t *lista, jogo_t *jogo){
	...
	htable_entrada_jogo_t *nova_entrada = can_fail_malloc(sizeof(htable_entrada_jogo_t));
...
void adicionar_a_lista_de_introduzidos(lista_intruduzidos_t **cabeca, jogo_t *jogo){
	...
	lista_intruduzidos_t *nova_entrada = can_fail_malloc(sizeof(lista_intruduzidos_t));
...
htable_entrada_jogo_t **cria_hashtable_jogo(){
	...
	hashtable_jogo = can_fail_malloc(sizeof(htable_entrada_jogo_t) * HASHTABLE_JOGO_TAMANHO);
