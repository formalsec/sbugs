...
int main(){
	...
	htable_entrada_jogo_t *t = can_fail_malloc(sizeof(htable_entrada_jogo_t));

	htable_entrada_t *eq = can_fail_malloc(sizeof(htable_entrada_t));
	...
	while (comando != 'x'){
		...
		case 'a':
			...
			nome_jogo = can_fail_malloc(sizeof(char) * (strlen(buffer) + 1));
			nome_1 = can_fail_malloc(sizeof(char) * (strlen(nome1) + 1));
			nome_2 = can_fail_malloc(sizeof(char) * (strlen(nome2) + 1));
		...
		case 'A':
			...
			nome_equipa = can_fail_malloc(sizeof(char) * (strlen(buffer) + 1));
