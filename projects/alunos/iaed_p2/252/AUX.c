...
{
    int i;
    team_list *lista = can_fail_malloc(sizeof(team_list));
    lista->head = NULL;
    lista->last = NULL;
    lista->hashtable = can_fail_malloc(sizeof(Equipa) * HASHSIZE);
...
{
    int i;
    game_list *lista = can_fail_malloc(sizeof(game_list));
    lista->head = NULL;
    lista->last = NULL;
