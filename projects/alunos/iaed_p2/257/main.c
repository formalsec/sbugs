...
int main(){
	...
	int* max_victories = can_fail_calloc(2, sizeof(int));	/* array that holds, in the first position, the greatest number of victories that 
	...
	Game_list* game_linked_list = can_fail_malloc(sizeof(Game_list_node*) * 2);
