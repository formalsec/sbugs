...
Node_team *insert_begin(Node_team *head, char *nome){
    Node_team *new = can_fail_malloc(sizeof(Node_team));
    
    new->nome = can_fail_malloc(sizeof(char) * (strlen(nome)+1));
...
Node_game *insert_end(Node_game_lst *Lst_jogos, char *nome_jogo, char *equipa1, char *equipa2,
    ...
    Node_game *new = can_fail_malloc(sizeof(Node_game));

    new->jogo = can_fail_malloc(sizeof(Jogo));
    new->jogo->nome = can_fail_malloc(sizeof(char) * (strlen(nome_jogo)+1));
    strcpy(new->jogo->nome, nome_jogo);
    new->jogo->equipa1 = can_fail_malloc(sizeof(char) * (strlen(equipa1)+1));
    strcpy(new->jogo->equipa1, equipa1);
    new->jogo->equipa2 = can_fail_malloc(sizeof(char) * (strlen(equipa2)+1));
...
Node_game_lst *init_node_game_lst(){
    Node_game_lst *Lst_jogos = can_fail_malloc(sizeof(Node_game_lst));
...
Node_g_ht *insert_begin_games(Node_g_ht *head, Node_game *node_game_ptr){
    Node_g_ht *new = can_fail_malloc(sizeof(Node_g_ht));
