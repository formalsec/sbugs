...
{
	hashtable_jogos * hash_jogos = can_fail_malloc(sizeof(hashtable_jogos));
	hash_jogos->capacity = CAP;
	hash_jogos->tb = can_fail_calloc(hash_jogos->capacity, sizeof(hash_node_jogos*));
	return hash_jogos;
}

hash_node_jogos *make_hashnode_j(hash_node_jogos *head, node_jogos *node)
{
	hash_node_jogos * hashnode_jogos = can_fail_malloc(sizeof(hash_node_jogos));
...
{														/* funcao de inicializacao da lista duplamente ligada*/
	lista_jogos *jogos = can_fail_malloc(sizeof(lista_jogos));
