...
{
    ptr_equipa new = (ptr_equipa)can_fail_malloc(sizeof(struct equipa)); /* Aloca memoria para a equipa */
    new->nome = can_fail_malloc((strlen(nome) + 1) * sizeof(char)); /* Aloca memoria para o nome da equipa */
