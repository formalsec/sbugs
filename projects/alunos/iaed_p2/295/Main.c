...
int main() {
    ...
    int a = 0, nl = 1;
    char c;
    conj_equipas = can_fail_malloc(sizeof(lista_equipas));
    inicia_lista_equipas(conj_equipas);

    conj_equipas_aux = can_fail_malloc(sizeof(lista_equipas_aux));
    inicia_lista_equipas_aux(conj_equipas_aux);

    conj_jogos = can_fail_malloc(sizeof(lista_jogos));
    inicia_lista_jogos(conj_jogos);

    conj_jogos_aux = can_fail_malloc(sizeof(lista_jogos_aux));
