...
hash_table_jogo *mk_hash_table_jg(int capacidade){
   hash_table_jogo *rv = can_fail_malloc(sizeof(hash_table_jogo));
   rv->capacidade = capacidade;
   rv->tb = can_fail_calloc(rv->capacidade, sizeof(node_jogo*));
   rv->last = NULL;
   return rv;
}
...
hash_table_equipa *mk_hash_table_eq(int capacidade){
   hash_table_equipa *rv = can_fail_malloc(sizeof(hash_table_jogo));
   rv->capacidade = capacidade;
   rv->tb = can_fail_calloc(rv->capacidade, sizeof(node_equipa*));
   return rv;
}
