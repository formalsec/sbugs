...
Team ** A(Team **T, int *T_sz, int *T_n, int *NL){
	Team *nt = (Team *) can_fail_malloc(sizeof(Team));
...
void g(Team **T, int *T_sz, int *T_n, int *NL){
	...
	char **t_names = (char **) can_fail_malloc(*T_n * sizeof(char*)); /* names of the teams with 
																the max games won */
...
int main(){
	int *NL = (int *) can_fail_malloc(sizeof(int));	/* lines of the commands to ease debugging */
	Game **G = NULL; 						/* games hash table */
	int *G_sz = (int *) can_fail_malloc(sizeof(int));/* games hash table size */
	int *G_n  =	(int *) can_fail_malloc(sizeof(int));/* number of existant games */
	Team **T = NULL; 						/* teams hash table */
	int *T_sz = (int *) can_fail_malloc(sizeof(int));/* teams hash table size */
	int *T_n  = (int *) can_fail_malloc(sizeof(int));/* number of existant teams */
	node **ends = can_fail_malloc(sizeof(node*) * 2);/* vector with ends of the list with the game's
	...
	*T_n = 0;
	...
	while((idc = getchar()) != 'x'){
		*NL += 1;
		switch(idc){
			case 'a':
				ng = can_fail_malloc(sizeof(Game));
