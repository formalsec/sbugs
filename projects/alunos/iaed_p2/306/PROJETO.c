...
void adiciona_equipa_lista(equipa *e){
    node_e *n=can_fail_malloc(sizeof(node_e)),*tmp=head_e;
    n->seguinte=NULL;
    n->equipa=e;
    n->anterior=NULL;
...
void adiciona_jogo_lista(jogo *j){
    node_j *n=can_fail_malloc(sizeof(node_j));
    n->seguinte=NULL;
    n->anterior=tail_j;
    n->jogo=j;
    if(tail_j !=NULL){
...
int AdicionarJogo(int nl,char dados[3098],int jogos){
    ...
    j1=can_fail_malloc(sizeof(jogo));
    j1->nome=can_fail_malloc(sizeof(char)*(strlen(nome_jogo)+1));
    j1->equipa1=can_fail_malloc(sizeof(char)*(strlen(equipa1)+1));
    j1->equipa2=can_fail_malloc(sizeof(char)*(strlen(equipa2)+1));
    j1->score1=score1;
    j1->score2=score2;
