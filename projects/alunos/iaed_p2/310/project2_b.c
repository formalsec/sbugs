...
{
    int i;
    TableJogos = can_fail_malloc(sizeof(struct jogos)*HTable_Size);
...
{
    int i;
    TableEquipas = can_fail_malloc(sizeof(struct equipas)*HTable_Size);
    for(i = 0; i < HTable_Size; i++){
        TableEquipas[i] = NULL;
    }
}
...
{
    pEquipas x = can_fail_malloc(sizeof(struct equipas));
    x->equipa = can_fail_malloc(sizeof(struct equipa));
    x->equipa->nome = can_fail_malloc(sizeof(char)*(strlen(buffer)+1));
...
{
    pJogos x = can_fail_malloc(sizeof(struct jogos));
    x->jogo = can_fail_malloc(sizeof(struct jogo));
    x->jogo->nome = can_fail_malloc(sizeof(char)*(strlen(nome)+1));
    x->jogo->equipa1 = can_fail_malloc(sizeof(char)*(strlen(equipa1)+1));
    x->jogo->equipa2 = can_fail_malloc(sizeof(char)*(strlen(equipa2)+1));
