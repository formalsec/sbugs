...
void adiciona_jogo(int nl, jogo * ht_jg, equipa * ht_eq) {
	...
	nome_jogo = can_fail_malloc((strlen(game) + 1) * sizeof(char));
	nome_eq1 = can_fail_malloc((strlen(team1) + 1) * sizeof(char));
	nome_eq2 = can_fail_malloc((strlen(team2) + 1) * sizeof(char));
