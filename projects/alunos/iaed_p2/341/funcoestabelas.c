...
HashTableJogos * IniciarHTJogos(){
    HashTableJogos * HTJ;
    HTJ = can_fail_malloc(sizeof(HashTableJogos));
    HTJ->capacidade = TAMANHOHT;
    /* Aloca memoria a todas as cabecas das listas das colisoes */
    HTJ->listasjog = can_fail_calloc(TAMANHOHT,sizeof(HashNoJogos*));
...
HashTableEquipas * IniciarHTEquipas(){
    ...
    HTE = can_fail_malloc(sizeof(HashTableEquipas));
    HTE->capacidade = TAMANHOHT;
    /* Aloca memoria a todas as cabecas das listas das colisoes */
    HTE->listasequi = can_fail_calloc(HTE->capacidade,sizeof(HashNoEquipas*));
...
void AdicionarHTEquipas(HashTableEquipas * HTE,int hash,NoSimplesEquipas * novo_no){
    ...
    HashNoEquipas * aux = can_fail_malloc(sizeof(HashNoEquipas));
...
void AdicionarHTJogos(HashTableJogos * HTJ,int hash,NoDuploJogos * novo_no){
    ...
    HashNoJogos * aux = can_fail_malloc(sizeof(HashNoJogos));
