...
lista_equipa* cria_lista_equipa(){
    ...
    lista_equipa* novaLista = (lista_equipa*) can_fail_malloc(sizeof(lista_equipa));
    if (novaLista == NULL)      /* Verifica alocacao de memoria. */
        puts("cria_lista: Error. can_fail_malloc returned NULL\n");
...
lista* cria_lista(){
    ...
    lista* novaLista = (lista*) can_fail_malloc(sizeof(lista));
    if (novaLista == NULL)      /* Verifica alocacao de memoria. */
        puts("cria_lista: Error. can_fail_malloc returned NULL\n");
    novaLista->inicio = NULL;   /* Inicializa inicio. */
    novaLista->fim = NULL;      /* Inicializa fim. */
...
lista_ponteiro* cria_lista_ponteiros(){
    ...
    lista_ponteiro* novaLista = (lista_ponteiro*) can_fail_malloc(sizeof(lista_ponteiro));
    if (novaLista == NULL)      /* Verifica alocacao de memoria. */
        puts("cria_lista: Error. can_fail_malloc returned NULL\n");
    novaLista->inicio = NULL;   /* Inicializa inicio. */
    novaLista->fim = NULL;      /* Inicializa fim. */
