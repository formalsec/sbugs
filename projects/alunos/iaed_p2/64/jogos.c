...
jogo insere_jogo(jogo *head, equipa *table_equipas, char *nome_jogo, char *nome_equipa1, char *nome_equipa2,int score1,int score2){
    jogo novo = (jogo)can_fail_malloc(sizeof(struct str_jogo));
    novo->nome = (char *) can_fail_malloc(sizeof(char)*(strlen(nome_jogo)+1));
    ...
    novo->score1 = (int *) can_fail_malloc(sizeof(int));
    *novo->score1 = score1;
    novo->score2 = (int *) can_fail_malloc(sizeof(int));
    *novo->score2 = score2; 
