...
indexNode * _add_index_(indexNode * head, int c){
    ...
    new = (indexNode *) can_fail_malloc(sizeof(indexNode));
    new->next = head;
    new->s = c;
...
nodeTeam * _push_team_(nodeTeam * head, char * name){
    ...
    new = (nodeTeam *) can_fail_malloc(sizeof(nodeTeam));
    team_addr = (Team * ) can_fail_malloc(sizeof(Team));
    team_name = (char * ) can_fail_malloc(sizeof(char)*(strlen(name)+1));
...
nodeGame * _push_game_(nodeGame * head, char * name, int id, int score1, int score2,
    ...
    new = (nodeGame *) can_fail_malloc(sizeof(nodeGame));
    game_addr = (Game * ) can_fail_malloc(sizeof(Game));
    game_name = (char *) can_fail_malloc(sizeof(char)*(strlen(name)+1));
    team1_name = (char *) can_fail_malloc(sizeof(char)*(strlen(team1)+1));
    team2_name = (char *) can_fail_malloc(sizeof(char)*(strlen(team2)+1));
