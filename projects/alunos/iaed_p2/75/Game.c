...
Game* newGame(char* name, Team* team1, Team* team2, int score1, int score2){
    Game* pnew_game = (Game*)can_fail_malloc(sizeof(Game)); /* Allocate space for Game structure */

    pnew_game -> pname = (char*)can_fail_malloc(sizeof(char)*(strlen(name)+1)); /* Allocate space for name of game */
