...
lista* init_lista(){
    ...
    lista* ls = (lista*) can_fail_malloc(sizeof(lista));
...
void insere_lista_ult(lista* ls,jogos* jogo){
    ...
    node* novo_node = (node*) can_fail_malloc(sizeof(node));
...
hashtable_jogos* init_hash_jogos(int tamanho){
    ...
    int i = 0;
    hashtable_jogos* hash_table = (hashtable_jogos*) can_fail_malloc(sizeof(hashtable_jogos));

    /*Criacao de uma hash table*/

    hash_table->hash = (jogos**) can_fail_malloc(sizeof(jogos*)*tamanho);
