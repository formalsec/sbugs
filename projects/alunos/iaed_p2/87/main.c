...
void add_jogo(int NL, hashtable_jogos* hash_jogos,hashtable_equipas* hash_equipas,lista* ls){
    ...
    novo_jogo = (jogos*) can_fail_malloc(sizeof(jogos));

    novo_jogo->score1 = score1;
    novo_jogo->score2 = score2;

    novo_jogo->nome = (char*) can_fail_malloc(sizeof(char)*(strlen(nome)+1));
    strcpy(novo_jogo->nome,nome);
    novo_jogo->equipa1 = (char*) can_fail_malloc(sizeof(char)*(strlen(equipa1)+1));
    strcpy(novo_jogo->equipa1,equipa1);
    novo_jogo->equipa2 = (char*) can_fail_malloc(sizeof(char)*(strlen(equipa2)+1));
...
void add_equipa(int NL, hashtable_equipas* hash_equipas){
    ...
    nova_equipa = (equipas*) can_fail_malloc(sizeof(equipas));

    nova_equipa->nome = (char*) can_fail_malloc(sizeof(char)*(strlen(nome)+1));
...
void equipas_maior_vitorias(int NL, hashtable_equipas* hash_equipas){
    ...
    vitorias_equipas = (char**) can_fail_malloc(sizeof(char*)*numero_equipas);
