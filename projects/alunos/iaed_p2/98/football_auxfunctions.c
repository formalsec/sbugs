...
{ 
    char* name = can_fail_malloc(sizeof(char)*(strlen(str)+1));
...
{
    Game_Link x = can_fail_malloc(sizeof(struct node_G));
...
{   
    ...
    x = can_fail_malloc(sizeof(struct node_G));
...
{
    Team_Link x = can_fail_malloc(sizeof(struct node_G));
