...
void novo_jogo(){
    ...
    j_aux1 = (char*) can_fail_malloc(lenght_j * sizeof(char) + 1);
    strcpy(j_aux1,j_aux);
    ...
    j1 = (node_jogo*) can_fail_malloc(sizeof(node_jogo));
    j2 = (node_jogo*) can_fail_malloc(sizeof(node_jogo));
...
void nova_equipa(){
    ...
    lenght = strlen(e_aux);
    e_aux1 = (char*) can_fail_malloc((lenght+1) * sizeof(char));
    strcpy(e_aux1,e_aux);
    ...
    e1 = (node_equipa*) can_fail_malloc(sizeof(node_equipa));
    e2 = (node_equipa*) can_fail_malloc(sizeof(node_equipa));
