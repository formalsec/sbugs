(module
  ...
  (elem (;0;) (i32.const 1) func $memset1)
  (data $.rodata (i32.const 1024) "summ_maximize\00S\00N\00M\00C\00num2\00num1\00%d\0a\00")
  (data $.data (i32.const 1060) "0\04\01\00\01\00\00\00"))
